...
$(document).ready(function () {
  ...
  new Typed('#typed-text', {
    strings: [
      ...
      "Des créations d'identités de marque",
      "Des conceptions de logos",
      "Des designs UI/UX",
      "Des designs web",
      "Des motions designs",
      "Des designs pour les réseaux sociaux",
      "Des designs d'impression",
      "Des designs packaging",
      "Des créations de contenus visuels",
      "Des designs marketing",
      "Des conseils créatifs",
      "Des conseils créatifs"
    ],
    typeSpeed: 50,
    backSpeed: 50,
